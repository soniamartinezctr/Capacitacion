...
$(document).ready(function () {
    ...
    $(function () {
        ...
        var $second = $("#bloque-objetivo");
        $second.hide();
        
        
        
        $("#go-imagen-objetivo").hover(function(){
            //alert("hola");
            $("#go-imagen-objetivo").css("margin-top","-15px");
            
        },function(){
            $("#go-imagen-objetivo").css("margin-top","0px");
        });

        $("#go-objetivos").click(function () {
...
//        $second = tmp;
        ...
        $("#objetivo-regresar").click(function () {
